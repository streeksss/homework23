      ...
      <div class="row">
        ...
        <div class="col-md-8 col-sm-6 col-xs-12">
          <div class="contact-right wow fadeInRight">
            ...
            <form action="" onsubmit="return false" id="sendletter" class="contact-form" method="POST">
              <div class="form-group">                
                <input  name="author" id="author" type="text" class="form-control" placeholder="Name">
              </div>
              <div class="form-group">                
              ...
              <button id="submit" type="submit" data-text="SUBMIT" class="button button-default"><span>SUBMIT</span></button>
            </form>
